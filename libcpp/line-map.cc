...
static const line_map_ordinary * linemap_ordinary_map_lookup (const line_maps *, location_t);
static const line_map_macro* linemap_macro_map_lookup (const line_maps *, location_t);
...
static location_t linemap_macro_loc_to_def_point (line_maps *, location_t, const line_map_ordinary **);
static location_t linemap_macro_loc_to_exp_point (line_maps *, location_t, const line_map_ordinary **);
